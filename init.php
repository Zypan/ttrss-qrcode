...
class QrcodeGen extends Plugin {
	...
	function hook_article_button($line) {
		...
		$rv = "<img src=\"".basename(dirname(__DIR__))."/qrcodegen/qrcode.png\"
	...
	function getQr() {
		...
		echo '<div><img src="' .basename(dirname(__DIR__)). '/qrcodegen/cache/' . $id . '.png" style="display: block; margin: 0 auto;"></div>';
